...
Let \( X \) be a space with closed singletons. Then \( X \) is \( T_3 \) iff for every subset \( A \subset X \) and its neighbourhood \( U \supset A \) we can find a smaller neighbourhood \( V \supset A \) such that \( \Cl V \subseteq U \).
\end{lemma}
