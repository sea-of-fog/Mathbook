...
\begin{proof}[Proof of the Vitali Covering Theorem.]
    The key to avoiding the \emph{trap} we wrote about after stating the VCT is to choose the segments to be as large as possible -- or at least, not embarassingly small.
    ...
    \[ 
       \mathcal{J}_n := \left\{ J_k : k < n \right\}, 
   \]
   and the \emph{width} of what we can choose is
    \[ 
       \gamma_n := \sup_{J \not\in \mathcal{J}_n} \diam J.  
    \]
    Note that in particular
    \begin{align*}
        \mathcal{J}_0 &= \varnothing, \\
        \gamma_0 &\leqslant \diam A.
    \end{align*}
\end{proof}
