...
\begin{thm}[Vitali Covering Theorem]
    ...
    If \( \mathcal{J} \) is a Vitali cover of \( A \), there exists a (possibly finite) sequence of pariwaise disjoint segments \( J_n \in \mathcal{J} \) such that
    \ankimark
    \[ 
